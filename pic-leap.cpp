...
#define J_X         2049           // Número de puntos de malla X. Recomendado: Del orden 2^n+1
#define J_Y         8           // Número de puntos de malla Y. Recomendado: Del orden 2^n
       ...
       for (int i=0;i<NSP;i++)
        {
           ...
           vel[i][X]=vel[i][X]-0.5*cte_E*Factor_carga_e*fact*Ep_X*dt;
           vel[i][Y]=vel[i][Y]-0.5*cte_E*Factor_carga_e*fact*Ep_Y*dt;
        }
    }
